...
#vbat_voltage = AnalogIn(boardtest.VOLTAGE_MONITOR)
...
header_text = Label(terminalio.FONT, text="  cybertooth lora                               Bat:" + battery_level,
...
rfm9x.send(bytes("cybertooth online - commlink open\r\n", "utf-8"))
term.write("cybertooth online - commlink open\r\n")
    ...
    while kbd.key_count > 0:
        ...
        if k[0] == STATE_PRESS:
            ...
            if k[1] == '\x08':  # Backspace
                ...
                text = 'cybertooth:' + input_text.text
            ...
            #    "  cybertooth lora                               Bat:" + battery_level)
